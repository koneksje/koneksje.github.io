...
;(function(){if(!("undefined"==typeof koneksje||"undefined"==typeof koneksje.assets)){var a=function(a,b){for(var c=0,d=a.length;c<d;c++)if(a[c]==b)return c;return-1}(koneksje.assets.required,"jquery.watch.js");if(-1!=a){koneksje.assets.required.splice(a,1);for(var a=document.getElementsByTagName("meta"),b=0,c=a.length;b<c;b++){var d=a[b];if("generator"==d.getAttribute("name")){"2018.0.0.379"!=d.getAttribute("content")&&koneksje.assets.outOfDate.push("jquery.watch.js");break}}}}})();
